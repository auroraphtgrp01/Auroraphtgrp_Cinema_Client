<template>
    <header class="main-header" id="headerNav" style="box-shadow: 0px 2px 3px rgba(255, 255, 255, 0.05);">
                        ...
                        <!-- <div v-else class="cart-box">
                            <div class="box-inner" style="text-transform: none;">
                                <div class
                                    ...
                                    <img src="../../../assets/client/images/avatar.png" 
        ...
        <div class="sticky-header" style="background-color: #0e1317;">
            <div class="auto-container">
                <div class="d-flex justify-content-between align-items-center">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="index.html" style="margin-left: 100px;"><img style="width: 130px; transform: scale(1.2);" q
                                src="../../../assets/client/images/logo-small.png"></a>
                    </div>
                            ...
                            <div class="cart-box">
                                <div class="box-inner" style="text-transform: none;">
                                    <div class style="width: 40px; height: 40px; left: 0; top: 3px; position: absolute;">
                                        <img src="../../../assets/client/images/avatar.png" style="border-radius: 30px;">
                                    </div>
                                    <b class style="color: #ED3232;">Lê Minh Tuấn</b><br>
                                    <a class="phone text-hover"><b>Đăng Xuất</b></a>
                                </div>
                            </div>
                        </nav>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="../../../assets/client/images/mobile-logo.png"></a>
                </div>
                <!-- Search -->
